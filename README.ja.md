...
PDFのページとJPG/PNG/WebP画像を、ファイルを外部へアップロードせずブラウザ内だけで整理・結合できる単一HTMLアプリです。
...
1. PDF・JPG・PNG・WebPを1つ以上追加します。複数ファイルをまとめてドラッグ＆ドロップできます。
2. PDFページと画像が同じカード一覧に並ぶので、カードをドラッグしてページ順を変更します。
...
- ページ数が多いPDFや高解像度の画像を多数追加すると、端末のメモリを多く使用します。
